...
function musicPlayer({name = "demo Song",describe = "nothing"}) {
  return (
    <div>
  ...
  <div class="flex items-center space-x-4">
    <img src="https://images.pexels.com/photos/414612/pexels-photo-414612.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" width="88" height="88" class="flex-none rounded-lg bg-slate-100" loading="lazy" />
