...
//but if u open up the promise object, it will show fullfilled state beause it is showing the current state of the promise and not the state when the console.log was executed
